...
//SETTING
       ...
       const kapankah = ['Otro día','Otra semana','Otro mes','Otro año']
        ...
        const reply = (teks) => {
            senpai.sendMessage(from, teks, text, {quoted:mek})
        }

        const sendMess = (hehe, teks) => {
            senpai.sendMessage(hehe, teks, text, {sendEphemeral: true})
        }

        const mentions = (teks, memberr, id) => {
            (id == null || id == undefined || id == false) ? senpai.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : senpai.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": memberr } })
        }
        const costum = (pesan, tipe, target, target2) => {
                 senpai.sendMessage(from, pesan, tipe, {quoted: {key: {fromMe: false, participant: `${target}`, ...(from ? {remoteJid: from}: {})}, message: {conversation: `${target2}` }}})
        }
        //FAKEH
const fakekontak = (teks) => {
senpai.sendMessage(from, teks, MessageType.text, {
quoted: {
key: {
fromMe: false,
...
'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ucapanWaktu},;;;\nFN:${ucapanWaktu},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')
        ...
        const fakethumb = (teks, yes) => {
            senpai.sendMessage(from, teks, image, {thumbnail:fs.readFileSync('./stik/fake.jpeg'),quoted:mek,caption:yes})
        }
        const fakestatus = (teks) => {
            senpai.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
...
const faketokoforwaded = (teks) => {
	  ...
	  contextInfo:{
        ...
        const sendStickerFromUrl = async(to, url) => {
                ...
                download(url, './stik' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${filess} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${asw}`, (err) => {
                        ...
                        senpai.sendMessage(to, media, MessageType.sticker,{quoted:mek})
        ...
        const sendMediaURL = async(to, url, text="", mids=[]) =>{
                ...
                download(url, filename, async function () {
                    ...
                    senpai.sendMessage(to, media, type, { quoted: mek, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
    ...
    const sendButImage = async (
      ...
      kma = gam1;
      mhan = await senpai.prepareMessage(from, kma, image);
    ...
    const sendButVideo = async (
      ...
      kma = vid1;
      mhan = await senpai.prepareMessage(from, kma, video);
      const buttonMessages = {
...
//========================================================================================================================//
  ...
  wew = fs.readFileSync('./src/foto.png')
					senpai.sendMessage(from, wew, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "Felixcrack BOT Ya esta verificado.", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./src/botlogo.webp')} } }, caption: help(prefix) })
				  break
case prefix+ 'idioma':
senpai.sendMessage(from, idioma(prefix, sender), text, {quoted: mek})
break
case prefix+ 'yomenu':
senpai.sendMessage(from, toinmenu(prefix, sender), text, {quoted: mek})
break
case prefix+ 'menuadmin':
senpai.sendMessage(from, menuadmin(prefix, sender), text, {quoted: mek})
break
case prefix+ 'nsfwmenu':
if (!isNsfw) return reply(mess.nsfwoff)
senpai.sendMessage(from, nsfwmenu(prefix, sender), text, {quoted: mek})
break
case prefix+ 'desmenu':
senpai.sendMessage(from, desmenu(prefix, sender), text, {quoted: mek})
break
case prefix+ 'versión':
case prefix+ 'version':
senpai.sendMessage(from, version(prefix, sender), text, {quoted: mek})
break
case prefix+ 'welmenu':
senpai.sendMessage(from, welmenu(prefix, sender), text, {quoted: mek})
break
...
case prefix+ 'gtts':
case 'tts':
if (args.length < 1) return senpai.sendMessage(from, `Debes usar el comando correctamente:\n${prefix}tts (lengua) (texto)\nEjemplo: ${prefix}tts Buen dia abortos\n\nUse: ${prefix}ts para enumerar todos los idiomas`, text, {quoted: mek})
const gtts = require('./lib/gtts')(args[0])
if (args.length < 2) return senpai.sendMessage(from, 'Y El Texto?', text, {quoted: mek})
dtt = body.slice(8)
ranm = getRandom('.mp3')
dtt.length > 800
? reply('¿Quieres Escribir La Biblia?')
: gtts.save(ranm, dtt, function() {
senpai.sendMessage(from, fs.readFileSync(ranm), audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
fs.unlinkSync(ranm)
})
break
...
case prefix+ 'hidetag':
			...
			var value = args.join(' ')
			var group = await senpai.groupMetadata(from)
			...
			senpai.sendMessage(from, optionshidetag, text)
			break
    case prefix+ 'sticktag':
            if ((isMedia && !mek.message.videoMessage || isQuotedSticker) && args.length == 0) {
            encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
            file = await senpai.downloadAndSaveMediaMessage(encmedia, filename = getRandom())
            value = args.join(" ")
            var group = await senpai.groupMetadata(from)
            var member = group['participants']
            var mem = []
            ...
            senpai.sendMessage(from, ini_buffer, MessageType.sticker, options)
            fs.unlinkSync(file)
            } else {
		    ...
		    case prefix+ 'giftag':
                ...
                download = await senpai.downloadMediaMessage(quoted)
                ...
                senpai.sendMessage(from, thumb, video, { contextInfo: {mentionedJid: mem }, quoted: mek, mimetype: 'video/gif', thumbnail: thumb })
			...
			case prefix+ 'doctag':
			  //by Dehanjing
                ...
                senpai.sendMessage(from, fs.readFileSync(`doc.txt`), document, { contextInfo: {mentionedJid: mem }, quoted: mek, mimetype: 'text/plain' })
    ...
    case prefix+ 'contag':
            ...
            + 'END:VCARD'.trim()
            senpai.sendMessage(from, {displayName: `${nah}`, vcard: vcard}, contact, {contextInfo: {"mentionedJid": members_ids}})
            break
    case prefix+ 'totag':
            if ((isMedia && !mek.message.videoMessage || isQuotedSticker) && args.length == 0) {
            encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
            ...
            ini_buffer = fs.readFileSync(file)
            senpai.sendMessage(from, ini_buffer, image, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            senpai.sendMessage(from, ini_buffer, audio, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            senpai.sendMessage(from, ini_buffer, video, options)
            fs.unlinkSync(file)
        } else{
...
case prefix+ 'closegc':
case 'closegp':
senpai.updatePresence(from, Presence.composing)
if (!isGroup) return reply(mess.only.group)
...
senpai.groupSettingChange (from, GroupSettingChange.messageSend, true);
reply(close)
break
case prefix+ 'opengc':
case 'opengp':
...
senpai.groupSettingChange (from, GroupSettingChange.messageSend, false);
reply(open)
break
case prefix+ 'kick':
if (!isGroup) return reply(mess.only.group)
					...
					senpai.groupRemove(from, mentioned)
					} else {
                 ...
                 case prefix+ 'pm':
					...
					if (mentioned.length > 1) {
						...
						mentions(teks, mentioned, true)
						senpai.groupMakeAdmin(from, mentioned)
					} else {
					...
					if (!isGroup) return reply(mess.only.group)
				    if (!isBotGroupAdmins) return reply(`「❗」ESTE COMANDO SOLO SE PUEDE USAR CUANDO EL BOT ES ADMIN`)
				    linkgc = await senpai.groupInviteCode (from)
				    yeh = `https://chat.whatsapp.com/${linkgc}\n\nLink Del Grupo *${groupName}*`
				    senpai.sendMessage(from, yeh, text, {quoted: mel })			       
					break
case prefix+ 'leave':
                    if (!isGroup) return reply(mess.only.group)
                    if (!isGroupAdmins) return reply(mess.only.admin)
                     setTimeout( () => {
					senpai.groupLeave (from) 
					}, 2000)
                     setTimeout( () => {
					senpai.updatePresence(from, Presence.composing) 
					senpai.sendMessage(from, 'Adios jotos👋', text) // ur cods
					}, 0)
                     break
       case prefix+ 'ownergrup':
          ...
          contextInfo: { mentionedJid: [from] }
           ...
           senpai.sendMessage(from, options, text, { quoted: mek } )
				break
...
case prefix+ 'tagall2':
				...
				senpai.updatePresence(from, Presence.composing) 
					...
					senpai.sendMessage(from, '𝙈𝙚𝙣𝙘𝙞𝙤𝙣 𝘿𝙚 𝙏𝙤𝙙𝙤𝙨'+teks+'✪ FX ┃ ᴮᴼᵀ ✪', text, {quoted: mek})
					break
                case prefix+ 'tagall3':
                case prefix+ 'marcar3':
				senpai.updatePresence(from, Presence.composing) 
					...
					senpai.sendMessage(from, '𝙼𝙴𝙽𝙲𝙸𝙾𝙽 𝙳𝙴 𝚃𝙾𝙳𝙾𝚂'+teks+'', text, {detectLinks: false, quoted: mek})
					break
                        case prefix+ 'tagall4':
                        case prefix+ 'marcar4':
				senpai.updatePresence(from, Presence.composing) 
					...
					senpai.sendMessage(from, '𝙈𝙚𝙣𝙘𝙞𝙤𝙣 𝘿𝙚 𝙏𝙤𝙙𝙤𝙨'+teks+'✔︎', text, {quoted: mek})
					break
                case prefix+ 'tagall5':
                case prefix+ 'marcar5':
				senpai.updatePresence(from, Presence.composing) 
...
case prefix+ 'tovid':
    case prefix+ 'tovideo':
            ...
            owgi = await senpai.downloadAndSaveMediaMessage(ger)
    ...
    case prefix+ 'tomp3':
            ...
            media = await senpai.downloadAndSaveMediaMessage(encmedia)
            ran = getRandom('.mp4')
            exec(`ffmpeg -i ${media} ${ran}`, (err) => {
            fs.unlinkSync(media)
            if (err) return fakegroup(`Err: ${err}`)
            buffer453 = fs.readFileSync(ran)
            senpai.sendMessage(from, buffer453, audio, { mimetype: 'audio/mp4', quoted: mek })
            fs.unlinkSync(ran)
            })
            break
    case prefix+ 'toimg':
      ...
      rano = getRandom('.webp')
			...
			exec(`wget ${anu.data.url} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
			  fs.unlinkSync(ranp)
				...
				senpai.sendMessage(from, buffer, MessageType.sticker, {quoted: mek})
				fs.unlinkSync(rano)
			})
			break
...
if (!isNsfw) return reply(mess.nsfwoff)
  pusiimg = await axios.get('https://nekos.life/api/v2/img/pussy_jpg')
			bufpusy = await getBuffer(pusiimg.data.url)
				senpai.sendMessage(from, bufpusy, MessageType.image, {quoted: mek})
			.catch(err => {
			return('Error 😔..')
			})
			break
...
if (!isNsfw) return reply(mess.nsfwoff)
			...
			senpai.sendMessage(from, bupyuri, image, { quoted: mek })
			.catch(err => {
			return('Error 😔..')
			})
			break
...
if (!isNsfw) return reply(mess.nsfwoff)
			...
			senpai.sendMessage(from, buferon, image, { quoted: mek })
			.catch(err => {
			return('Error 😔..')
			})
			break
...
if (!isNsfw) return reply(mess.nsfwoff)
			...
			senpai.sendMessage(from, bufero, image, { quoted: mek })
			.catch(err => {
...
if (!isNsfw) return reply(mess.nsfwoff)
	...
	if (!isNsfw) return reply(mess.nsfwoff)
			...
			senpai.sendMessage(from, bufhtz, image, {quoted: mek})
			.catch(err => {
			return('Error 😔..')
			})
			break
...
senpai.sendMessage(from, attp2, MessageType.sticker, selepbot, {quoted: mek })
						break
...
break
       ...
       //OWNER BOT
            ...
            if (!mek.key.fromMe) return fakestatus('「 ❗ 」ESTE COMANDO SOLO PUEDE SER USADO POR MI')
            var chats = await senpai.chats.all()
            chats.map( async ({ jid }) => {
            await senpai.chatRead(jid)
            })
		    var teks = `\`\`\`Fueron Leídos ${chats.length} Chats !\`\`\``
	        await senpai.sendMessage(from, teks, text, {quoted: mek})
...
reply(mess.mpv)
	...
	case prefix+ 'ytsearch':
        	...
        	return await senpai.sendMessage(from, 'Error!', MessageType.text, dload)
    		}
    		aramat = aramas.all 
...
case prefix+ 'play':
    ...
    senpai.sendMessage(from, options, text, { quoted: mek } )
				break
case prefix+ 'creador':
await senpai.sendMessage(from, {displayname: "Félix🧙‍♂️", vcard: vcard}, MessageType.contact)
break
